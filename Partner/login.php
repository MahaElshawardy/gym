...
include_once "../app/middleware/guestPartner.php";
?>
        ...
        <div class="row mt-5">
            ...
            <div class="col-md-12 mt-5">
                ...
                <div class="card col-md-6 offset-3 mt-5 ">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="../app/post/login_partner.php" method="post" id="quickForm">
                        <div class="card-body">
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-primary" name="loginPartner">Login</button>
                        </div>
                    </form>
                </div>
                <!-- /.card -->
