                            ...
                            <div class="card-body pt-1">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <p class="text-muted text-sm"><b>About: </b> <b>Gender</b>
                                            <?= $member['Gender']?> /
                                    ...
                                    <div class="row">
                                        <div class="col-7">
                                            ...
                                            <ul class="ml-4 mb-0 fa-ul text-muted">
                                                ...
                                                <li class="small"><span class="fa-li"><i
                                                            class="fas fa-lg fa-phone"></i></span>
                                                    Phone #: <?= $employee['Phone_Number'] ?> Phone2 #:
                                                    <?= $employee['Phone_Number2'] ?></li>
                                            </ul>
                                        </div>
                                        <div class="col-5 text-center">
                                            <img src="../Employees/dist/img/<?= $employee['Personal_Image'] ?>"
                                                style="height: 130px;width: 100%;" alt="" class="img-circle img-fluid">
                                        </div>
                                    </div>
                                </div>
                                <div class="card-footer">
                                    <div class="text-right">
                                        <a href="profile.php?Employee_ID=<?= $employee['Employee_ID'] ?>"
