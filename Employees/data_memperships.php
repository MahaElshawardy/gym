<?php
$title = "Data Memberships";
$icon = "<a href='add_memberships.php'><i class='fas fa-plus-circle'></i></a>";
                  ...
                  <tbody>
                    <?php if ($memberResult) : ?>
                      ...
                      <?php foreach ($members as $key => $member) : ?>
                        <tr>
                          <td><a href="#"><?= $member['Mempership_ID'] ?></a></td>
                          <td><?= $member['Category'] ?></td>
                          <td><?= $member['Price'] ?></td>
                          <td><?= $member['Period'] ?></td>
                          <td><?= $member['Discount_Percentage']."<b> %</b>" ?></td>
                          <td><a class="btn btn-warning" href="edit_memberships.php?Mempership_ID=<?= $member['Mempership_ID'] ?>" >Edit</a></td>
                        </tr>
                      <?php endforeach ?>
                    <?php endif ?>
                  </tbody>
